...
import (
	...
	"github.com/hanzo-git/runner/internal/pkg/client/mocks"
...
// https://github.com/hanzo-git/runner/issues/793:
//
...
// Regression test for https://github.com/hanzo-git/runner/issues/950: Close() must
...
// TODO: Remove after https://github.com/hanzo-git/runner/pull/37631 is in all
...
// TestReporter_ServerCancelStillFlushesFinal asserts that when the Git server
...
// cancelled, so retry-go aborted on its context check and Git never received
...
// Cancelled flow: it gives Git an explicit cancel acknowledgement rather
