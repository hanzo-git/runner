...
import (
	...
	"github.com/hanzo-git/runner/internal/app/poll"
	...
	"github.com/hanzo-git/runner/internal/pkg/envcheck"
...
func runDaemon(ctx context.Context, daemArgs *daemonArgs, configFile *string) func(cmd *cobra.Command, args []string) error {
	return func(cmd *cobra.Command, args []string) error {
		...
		if err != nil && connect.CodeOf(err) == connect.CodeUnimplemented {
			log.Errorf("Your Hanzo Git version is too old to support runner declare, please upgrade to v1.21 or later")
			return err
		} else if err != nil {
