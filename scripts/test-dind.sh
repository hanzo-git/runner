...
# daemon-level regression surfaces here (e.g. the "docker cp" break in hanzo-git/runner#981).
...
name="git-runner-dind-test-$$"
image="${DIND_TEST_IMAGE:-git-runner-${target}:dind-test}"
