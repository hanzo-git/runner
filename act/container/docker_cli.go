...
//nolint:errcheck // verbatim copy from docker/cli with minimal changes
package container
...
func applyContainerOptions(n *opts.NetworkAttachmentOpts, copts *containerOptions) error { //nolint:gocyclo // verbatim copy from docker/cli
